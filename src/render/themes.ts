...
const FRUIT_ART: readonly Rung[] = [
  { name: 'Blueberry', color: '#1f5ed6', art: { file: 'fruit/0.webp', w: 272, h: 262, cx: 0.489, cy: 0.4885, span: 220 } },
  { name: 'Strawberry', color: '#d9381c', art: { file: 'fruit/1.webp', w: 260, h: 294, cx: 0.4962, cy: 0.4898, span: 242 } },
  { name: 'Blackberry', color: '#5d3fc6', art: { file: 'fruit/2.webp', w: 260, h: 286, cx: 0.4923, cy: 0.493, span: 232 } },
  { name: 'Lemon', color: '#ddc619', art: { file: 'fruit/3.webp', w: 262, h: 292, cx: 0.5382, cy: 0.4966, span: 236 } },
  { name: 'Orange', color: '#f09f21', art: { file: 'fruit/4.webp', w: 282, h: 280, cx: 0.4929, cy: 0.4857, span: 238 } },
  { name: 'Pear', color: '#abd124', art: { file: 'fruit/5.webp', w: 238, h: 300, cx: 0.5084, cy: 0.4767, span: 256 } },
  { name: 'Apple', color: '#dd2717', art: { file: 'fruit/6.webp', w: 262, h: 294, cx: 0.4847, cy: 0.5034, span: 238 } },
  { name: 'Pineapple', color: '#d4a317', art: { file: 'fruit/7.webp', w: 234, h: 304, cx: 0.4915, cy: 0.4539, span: 278 } },
];

const PLANETS_ART: readonly Rung[] = [
  { name: 'Moon', color: '#ddcec9', art: { file: 'planets/0.webp', w: 260, h: 262, cx: 0.4462, cy: 0.4924, span: 226 } },
  { name: 'Mars', color: '#d53621', art: { file: 'planets/1.webp', w: 258, h: 244, cx: 0.5426, cy: 0.4959, span: 226 } },
  { name: 'Saturn', color: '#e29e35', art: { file: 'planets/2.webp', w: 328, h: 232, cx: 0.4939, cy: 0.4784, span: 326 } },
  { name: 'Earth', color: '#52adc4', art: { file: 'planets/3.webp', w: 266, h: 266, cx: 0.4511, cy: 0.4962, span: 234 } },
  { name: 'Neptune', color: '#1360d9', art: { file: 'planets/4.webp', w: 264, h: 262, cx: 0.4924, cy: 0.4924, span: 220 } },
  { name: 'Jupiter', color: '#dfb07d', art: { file: 'planets/5.webp', w: 268, h: 264, cx: 0.4925, cy: 0.4962, span: 216 } },
  { name: 'Venus', color: '#d9711c', art: { file: 'planets/6.webp', w: 268, h: 266, cx: 0.4925, cy: 0.5075, span: 216 } },
  { name: 'Sun', color: '#e6a811', art: { file: 'planets/7.webp', w: 298, h: 304, cx: 0.5034, cy: 0.5, span: 254 } },
];

const GEMS_ART: readonly Rung[] = [
  { name: 'Pearl', color: '#e2cfc8', art: { file: 'gems/0.webp', w: 242, h: 242, cx: 0.4876, cy: 0.4917, span: 200 } },
  { name: 'Emerald', color: '#1eca4d', art: { file: 'gems/1.webp', w: 230, h: 260, cx: 0.4783, cy: 0.5077, span: 206 } },
  { name: 'Ruby', color: '#d61b5a', art: { file: 'gems/2.webp', w: 268, h: 266, cx: 0.4888, cy: 0.5, span: 220 } },
  { name: 'Topaz', color: '#dd8719', art: { file: 'gems/3.webp', w: 224, h: 298, cx: 0.4955, cy: 0.5, span: 248 } },
  { name: 'Amethyst', color: '#9435da', art: { file: 'gems/4.webp', w: 240, h: 284, cx: 0.5, cy: 0.4859, span: 242 } },
  { name: 'Sapphire', color: '#1545dc', art: { file: 'gems/5.webp', w: 250, h: 254, cx: 0.504, cy: 0.4921, span: 208 } },
  { name: 'Peridot', color: '#29ce46', art: { file: 'gems/6.webp', w: 242, h: 258, cx: 0.4917, cy: 0.5, span: 208 } },
  { name: 'Diamond', color: '#5ea7e7', art: { file: 'gems/7.webp', w: 266, h: 258, cx: 0.4887, cy: 0.5, span: 226 } },
];

const SWEETS_ART: readonly Rung[] = [
  { name: 'Cookie', color: '#dc8d34', art: { file: 'sweets/0.webp', w: 268, h: 240, cx: 0.4478, cy: 0.5, span: 234 } },
  { name: 'Jelly bean', color: '#8c33d7', art: { file: 'sweets/1.webp', w: 256, h: 266, cx: 0.4961, cy: 0.5075, span: 216 } },
  { name: 'Lollipop', color: '#cd9da3', art: { file: 'sweets/2.webp', w: 238, h: 294, cx: 0.5126, cy: 0.5068, span: 248 } },
  { name: 'Marshmallow', color: '#f09bb3', art: { file: 'sweets/3.webp', w: 240, h: 256, cx: 0.4958, cy: 0.4922, span: 210 } },
  { name: 'Cupcake', color: '#e88d94', art: { file: 'sweets/4.webp', w: 242, h: 294, cx: 0.5, cy: 0.4898, span: 250 } },
  { name: 'Ice cream', color: '#e6b574', art: { file: 'sweets/5.webp', w: 184, h: 304, cx: 0.5109, cy: 0.4836, span: 264 } },
  { name: 'Donut', color: '#e85e6a', art: { file: 'sweets/6.webp', w: 290, h: 266, cx: 0.4931, cy: 0.485, span: 236 } },
  { name: 'Gumball', color: '#ed9e26', art: { file: 'sweets/7.webp', w: 254, h: 264, cx: 0.5039, cy: 0.4962, span: 216 } },
];

const OCEAN_ART: readonly Rung[] = [
  { name: 'Clownfish', color: '#e0753a', art: { file: 'ocean/0.webp', w: 304, h: 236, cx: 0.5066, cy: 0.4746, span: 290 } },
  { name: 'Starfish', color: '#e8a92f', art: { file: 'ocean/1.webp', w: 280, h: 268, cx: 0.4571, cy: 0.4851, span: 250 } },
  { name: 'Pufferfish', color: '#e7b227', art: { file: 'ocean/2.webp', w: 294, h: 264, cx: 0.4932, cy: 0.5076, span: 236 } },
  { name: 'Jellyfish', color: '#2fcbd8', art: { file: 'ocean/3.webp', w: 250, h: 302, cx: 0.496, cy: 0.5, span: 248 } },
  { name: 'Pink jellyfish', color: '#e63996', art: { file: 'ocean/4.webp', w: 258, h: 300, cx: 0.4845, cy: 0.5133, span: 254 } },
  { name: 'Sea urchin', color: '#c4aa71', art: { file: 'ocean/5.webp', w: 282, h: 264, cx: 0.4965, cy: 0.5265, span: 230 } },
  { name: 'Sea jelly', color: '#8b3ada', art: { file: 'ocean/6.webp', w: 274, h: 290, cx: 0.5036, cy: 0.5, span: 244 } },
  { name: 'Blue tang', color: '#3d8ed0', art: { file: 'ocean/7.webp', w: 320, h: 258, cx: 0.5125, cy: 0.5233, span: 274 } },
];

const ANIMALS_ART: readonly Rung[] = [
  { name: 'Fox', color: '#ec7934', shape: { path: sphere }, art: { file: 'animals/0.webp', w: 240, h: 258, cx: 0.5208, cy: 0.4845, span: 216 } },
  { name: 'Rabbit', color: '#f07998', shape: { path: sphere }, art: { file: 'animals/1.webp', w: 212, h: 282, cx: 0.5189, cy: 0.4752, span: 234 } },
  { name: 'Chick', color: '#eeb412', shape: { path: sphere }, art: { file: 'animals/2.webp', w: 220, h: 244, cx: 0.5409, cy: 0.5, span: 186 } },
  { name: 'Frog', color: '#6dd72a', shape: { path: sphere }, art: { file: 'animals/3.webp', w: 232, h: 224, cx: 0.5474, cy: 0.4643, span: 196 } },
  { name: 'Cat', color: '#a259d6', shape: { path: sphere }, art: { file: 'animals/4.webp', w: 240, h: 250, cx: 0.5292, cy: 0.492, span: 200 } },
  { name: 'Whale', color: '#1d8ce6', shape: { path: sphere }, art: { file: 'animals/5.webp', w: 240, h: 280, cx: 0.5208, cy: 0.4786, span: 230 } },
  { name: 'Red panda', color: '#dd725e', shape: { path: sphere }, art: { file: 'animals/6.webp', w: 240, h: 232, cx: 0.5458, cy: 0.5086, span: 212 } },
  { name: 'Lion', color: '#e9a21e', shape: { path: sphere }, art: { file: 'animals/7.webp', w: 240, h: 266, cx: 0.525, cy: 0.4925, span: 228 } },
];

const VEGETABLES_ART: readonly Rung[] = [
  { name: 'Tomato', color: '#dd301b', shape: { path: sphere }, art: { file: 'vegetables/0.webp', w: 240, h: 248, cx: 0.5083, cy: 0.4758, span: 210 } },
  { name: 'Carrot', color: '#e18116', shape: { path: sphere }, art: { file: 'vegetables/1.webp', w: 228, h: 280, cx: 0.5088, cy: 0.4857, span: 234 } },
  { name: 'Broccoli', color: '#59c42d', shape: { path: sphere }, art: { file: 'vegetables/2.webp', w: 240, h: 276, cx: 0.5458, cy: 0.4928, span: 230 } },
  { name: 'Aubergine', color: '#a168c1', shape: { path: sphere }, art: { file: 'vegetables/3.webp', w: 230, h: 286, cx: 0.5043, cy: 0.458, span: 248 } },
  { name: 'Corn', color: '#d2c719', shape: { path: sphere }, art: { file: 'vegetables/4.webp', w: 226, h: 292, cx: 0.4779, cy: 0.4726, span: 246 } },
  { name: 'Chilli', color: '#dc3620', shape: { path: sphere }, art: { file: 'vegetables/5.webp', w: 224, h: 280, cx: 0.4688, cy: 0.4714, span: 234 } },
  { name: 'Cucumber', color: '#5ac537', shape: { path: sphere }, art: { file: 'vegetables/6.webp', w: 234, h: 288, cx: 0.4573, cy: 0.4688, span: 252 } },
  { name: 'Garlic', color: '#e3cfcb', shape: { path: sphere }, art: { file: 'vegetables/7.webp', w: 240, h: 272, cx: 0.4958, cy: 0.4816, span: 228 } },
];

const MAGIC_ART: readonly Rung[] = [
  { name: 'Crystal ball', color: '#bc5dd0', shape: { path: sphere }, art: { file: 'magic/0.webp', w: 240, h: 288, cx: 0.475, cy: 0.4896, span: 232 } },
  { name: 'Wand', color: '#e0a51f', shape: { path: sphere }, art: { file: 'magic/1.webp', w: 222, h: 290, cx: 0.5135, cy: 0.4862, span: 240 } },
  { name: 'Potion', color: '#439edb', shape: { path: sphere }, art: { file: 'magic/2.webp', w: 218, h: 296, cx: 0.4862, cy: 0.4764, span: 248 } },
  { name: 'Fairy wings', color: '#e369b6', shape: { path: sphere }, art: { file: 'magic/3.webp', w: 240, h: 290, cx: 0.4958, cy: 0.4862, span: 236 } },
  { name: 'Spell book', color: '#adc840', shape: { path: sphere }, art: { file: 'magic/4.webp', w: 240, h: 292, cx: 0.4792, cy: 0.5068, span: 242 } },
  { name: 'Flame', color: '#e56712', shape: { path: sphere }, art: { file: 'magic/5.webp', w: 240, h: 296, cx: 0.475, cy: 0.4831, span: 252 } },
  { name: 'Wizard hat', color: '#1089e5', shape: { path: sphere }, art: { file: 'magic/6.webp', w: 240, h: 284, cx: 0.4958, cy: 0.493, span: 236 } },
  { name: 'Unicorn horn', color: '#ceb09e', shape: { path: sphere }, art: { file: 'magic/7.webp', w: 222, h: 296, cx: 0.5045, cy: 0.4899, span: 244 } },
];

const INSECTS_ART: readonly Rung[] = [
  { name: 'Butterfly', color: '#ecaa15', shape: { path: sphere }, art: { file: 'insects/0.webp', w: 240, h: 272, cx: 0.4875, cy: 0.489, span: 232 } },
  { name: 'Ladybird', color: '#d53328', shape: { path: sphere }, art: { file: 'insects/1.webp', w: 232, h: 248, cx: 0.4957, cy: 0.4597, span: 214 } },
  { name: 'Caterpillar', color: '#72d025', shape: { path: sphere }, art: { file: 'insects/2.webp', w: 240, h: 202, cx: 0.5125, cy: 0.5099, span: 220 } },
  { name: 'Dragonfly', color: '#2a92e0', shape: { path: sphere }, art: { file: 'insects/3.webp', w: 240, h: 272, cx: 0.4958, cy: 0.4779, span: 236 } },
  { name: 'Bee', color: '#a64ed0', shape: { path: sphere }, art: { file: 'insects/4.webp', w: 240, h: 248, cx: 0.5, cy: 0.4798, span: 208 } },
  { name: 'Ant', color: '#e15518', shape: { path: sphere }, art: { file: 'insects/5.webp', w: 240, h: 264, cx: 0.5083, cy: 0.4773, span: 230 } },
  { name: 'Firefly', color: '#e275a5', shape: { path: sphere }, art: { file: 'insects/6.webp', w: 240, h: 294, cx: 0.5208, cy: 0.4966, span: 234 } },
  { name: 'Mantis', color: '#28d4c6', shape: { path: sphere }, art: { file: 'insects/7.webp', w: 240, h: 296, cx: 0.5, cy: 0.4932, span: 258 } },
];

const WEATHER_ART: readonly Rung[] = [
  { name: 'Cloud', color: '#dbd6e6', shape: { path: sphere }, art: { file: 'weather/0.webp', w: 240, h: 232, cx: 0.4833, cy: 0.4914, span: 230 } },
  { name: 'Lightning', color: '#e8b118', shape: { path: sphere }, art: { file: 'weather/1.webp', w: 192, h: 258, cx: 0.5, cy: 0.4961, span: 210 } },
  { name: 'Raindrop', color: '#1a8bde', shape: { path: sphere }, art: { file: 'weather/2.webp', w: 198, h: 280, cx: 0.4949, cy: 0.4929, span: 222 } },
  { name: 'Sun', color: '#e3760f', shape: { path: sphere }, art: { file: 'weather/3.webp', w: 240, h: 292, cx: 0.4583, cy: 0.4966, span: 236 } },
  { name: 'Tornado', color: '#a746dc', shape: { path: sphere }, art: { file: 'weather/4.webp', w: 240, h: 292, cx: 0.45, cy: 0.5068, span: 246 } },
  { name: 'Snowflake', color: '#29a8da', shape: { path: sphere }, art: { file: 'weather/5.webp', w: 232, h: 280, cx: 0.4698, cy: 0.4964, span: 220 } },
  { name: 'Rainbow', color: '#d4a180', shape: { path: sphere }, art: { file: 'weather/6.webp', w: 240, h: 236, cx: 0.4958, cy: 0.5042, span: 236 } },
  { name: 'Storm cloud', color: '#1661d1', shape: { path: sphere }, art: { file: 'weather/7.webp', w: 240, h: 288, cx: 0.5208, cy: 0.4965, span: 228 } },
];
