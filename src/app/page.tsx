    ...
    <main className="mx-auto flex min-h-screen w-full max-w-xl flex-col justify-center gap-6 px-5 py-10">
      <header>
        ...
        <p className="mt-1.5 text-sm leading-relaxed text-[#8b90a0]">
          Seven balls, one ring. Each one lays threads to the wall as it goes, and they stay there —
          touch somebody else&apos;s and you are out. Last ball standing ends the video, so no two
          run the same length.
        </p>
      </header>
